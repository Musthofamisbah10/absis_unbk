...
<div class="row" style="width:100%">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td widht="50%" style="text-align: right">
                        ...
                        <input type="button" value="Selesai" class="selesai button button-blue" id="btnSelesai" name="next" alt="0">
                    </td>
                </tr>
            </table>
    ...
    $(document).ready(function(){
        ...
        var updateListJawaban = function(){
            ...
            var link = "/admin/tryout/ujian/"+kode_to+"/"+id_mapel+"/"+no_soal+"/jawaban";
        ...
        $('body').on('click','.jawab',function(){
            ...
            var link = "/admin/tryout/ujian/"+kode_to+"/"+id_mapel+"/"+kode_soal+"/kirim_jawaban";
        ...
        $('body').on('click','.next',function(){
            ...
            if (no_soal==jumlah_soal) {
                ...
                var link = "/admin/tryout/ujian/"+kode_to+"/"+id_mapel+"/"+kode_soal+"/selesai";
